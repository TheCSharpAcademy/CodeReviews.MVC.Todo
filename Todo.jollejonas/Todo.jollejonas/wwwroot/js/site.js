...
function displayDeleteConfirm(id) {
    ...
    document.getElementById('delete-name').innerText = item.name;
...
function successMessage() {
    ...
    message.innerHTML = 'Item updated successfully!';
    setTimeout(function () {
...
function _displayItems(data) {
    ...
    data.forEach(item => {
        ...
        deleteButton.setAttribute('onclick', `displayDeleteConfirm(${item.id})`);
